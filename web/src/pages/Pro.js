							...
							<div className='row' style='margin-bottom:10px;'>
								<div className='col-sm-12'>
									<div id='info' style='text-align: center; padding-top:40px; padding-bottom: 15px;'>
										<p id='contentName' style="font-family: 'Arial'; font-size: 60px;">
											Abc Xyz
										</p>
									</div>
									<div id='contact'>
					...
					<div className='modal-content'>
						<div className='modal-body'>
							...
							<div className='checkbox'>
								<label>
									<input type='checkbox' name='sectionToggle' checked='true' value='sectionEducation' />
									Education
								</label>
							</div>
							<div className='checkbox'>
								<label>
									<input type='checkbox' name='sectionToggle' checked='true' value='sectionExperience' />
									Experience
								</label>
							</div>
							<div className='checkbox'>
								<label>
									<input type='checkbox' name='sectionToggle' checked='true' value='sectionPublications' />
									Publications
								</label>
							</div>
							<div className='checkbox'>
								<label>
									<input type='checkbox' name='sectionToggle' checked='true' value='sectionProjects' />
									Projects
								</label>
							</div>
							<div className='checkbox'>
								<label>
									<input type='checkbox' name='sectionToggle' checked='true' value='sectionSkills' />
									Technical Skills
								</label>
							</div>
							<div className='checkbox'>
								<label>
									<input type='checkbox' name='sectionToggle' checked='true' value='sectionResponsibility' />
									Positions of Responsibility
								</label>
							</div>
							<div className='checkbox'>
								<label>
									<input type='checkbox' name='sectionToggle' checked='true' value='sectionAchievements' />
									Achievements
								</label>
							</div>
							<div className='checkbox'>
								<label>
									<input type='checkbox' name='sectionToggle' checked='true' value='sectionCourses' />
									Key courses taken
								</label>
							</div>
							<div className='checkbox'>
								<label>
									<input type='checkbox' name='sectionToggle' checked='true' value='sectionlinks' />
									Links
								</label>
							</div>
							<div className='checkbox'>
								<label>
									<input type='checkbox' name='sectionToggle' checked='true' value='sectionCurricular' />
									Hobbies
								</label>
							</div>
							<div className='checkbox'>
