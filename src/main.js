...
export default function template(value) {
	if (value === "default") {
		...
		for (i = 0; i < defaultTemplateVars.length; i++) $("#" + defaultTemplateVars[i]).on("click");
	} else {
...
function toggleSection(sectionName, toggleState) {
	if (toggleState === true) $('input[value="' + sectionName + '"]').attr("checked", "true");
...
export function changeTemplate(toggleType, toggleValue) {
	switch (toggleType) {
		...
		case "contact":
			...
			break;
		case "margin":
			if (toggleValue === "margin1") $("#page").css("padding", "0.2cm 1cm 1cm 1cm");
			else if (toggleValue === "margin2") $("#page").css("padding", "0.2cm 1.1cm 1cm 1.1cm");
			else if (toggleValue === "margin3") $("#page").css("padding", "0.2cm 1.2cm 1cm 1.2cm");
			else if (toggleValue === "margin4") $("#page").css("padding", "0.2cm 1.3cm 1cm 1.3cm");
			else if (toggleValue === "margin5") $("#page").css("padding", "0.2cm 1.4cm 1cm 1.4cm");
			else if (toggleValue === "margin6") $("#page").css("padding", "0.2cm 1.5cm 1cm 1.5cm");
			break;
		case "line":
			if (toggleValue === "line1") $("#page").css("line-height", "1.1em");
			else if (toggleValue === "line2") $("#page").css("line-height", "1.2em");
			else if (toggleValue === "line3") $("#page").css("line-height", "1.3em");
			else if (toggleValue === "line4") $("#page").css("line-height", "1.4em");
			else if (toggleValue === "line5") $("#page").css("line-height", "1.5em");
			else if (toggleValue === "line6") $("#page").css("line-height", "1.6em");
			break;
		case "column":
			if (toggleValue === "column1") $(".table tbody tr td:nth-child(1)").toggleClass("text-center");
			else if (toggleValue === "column2") $(".table tbody tr td:nth-child(2)").toggleClass("text-center");
			else if (toggleValue === "column3") $(".table tbody tr td:nth-child(3)").toggleClass("text-center");
			else if (toggleValue === "column4") $(".table tbody tr td:nth-child(4)").toggleClass("text-center");
			break;

		case "font":
			if (toggleValue === "fontVerdanaSans") $("#page").removeClass("droid").removeClass("roboto").removeClass("verdana-serif").addClass("verdana-sans");
			else if (toggleValue === "fontVerdanaSerif") $("#page").removeClass("verdana-sans").removeClass("droid").removeClass("roboto").addClass("verdana-serif");
			else if (toggleValue === "fontRoboto") $("#page").removeClass("verdana-serif").removeClass("verdana-sans").removeClass("droid").addClass("roboto");
			else if (toggleValue === "fontDroid") $("#page").removeClass("roboto").removeClass("verdana-serif").removeClass("verdana-sans").addClass("droid");
			break;
		case "case":
			if (toggleValue === "caseNormal") $(".section-title").removeClass("uppercase");
			else $(".section-title").addClass("uppercase");
			break;
		case "title":
...
export function decreaseIndent() {
	let node = getSelectionContainerElement();
	while (node.tagName !== "UL") node = node.parentNode;
