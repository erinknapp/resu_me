                        ...
                        <div id="panel">
                            ...
                            <h5>
                                ...
                                <div className="toggle-button">
                                    <div className="toggle-option" data-toggle="minor" id="minorShow">Show</div>
                                    <div className="toggle-option selected" data-toggle="minor" id="minorHide">Hide</div>
                                </div>
                            </h5>
                            <h5>
                                Contact Lines
                                <div className="toggle-button">
                                    ...
                                    <div className="toggle-option" data-toggle="contact" id="contact5">4</div>
                                </div>
                            </h5>
                            <h5>
                                Horizontal Margin
                                <div className="toggle-button">
                                    ...
                                    <div className="toggle-option" data-toggle="margin" id="margin3">3</div>
                                    <div className="toggle-option selected" data-toggle="margin" id="margin4">4</div>
                                    <div className="toggle-option" data-toggle="margin" id="margin5">5</div>
                                    <div className="toggle-option" data-toggle="margin" id="margin6">6</div>
                                </div>
                            </h5>
                            <h5>
                                Line Spacing
                                <div className="toggle-button">
                                    ...
                                    <div className="toggle-option" data-toggle="line" id="line3">3</div>
                                    <div className="toggle-option selected" data-toggle="line" id="line4">4</div>
                                    <div className="toggle-option" data-toggle="line" id="line5">5</div>
                                    <div className="toggle-option" data-toggle="line" id="line6">6</div>
                                </div>
                            </h5>
                            <h5>
                                Center Column no.
                                <div className="toggle-button">
                                    ...
                                    <div className="toggle-option multi-select" data-toggle="column" id="column3">3</div>
                                    <div className="toggle-option multi-select" data-toggle="column" id="column4">4</div>
                                </div>
                            </h5>
                            ...
                            <h5>
                                ...
                                <div className="toggle-button">
                                    ...
                                    <button className="btn btn-xs custom-button" onClick={() => changeListStyle('square')}>&#9632;</button>
                                    <button className="btn btn-xs custom-button" onClick={() => changeListStyle('dash')}>-</button>
                                    <button className="btn btn-xs custom-button" onClick={() => changeListStyle('decimal')}>1.</button>
                                    <button className="btn btn-xs custom-button" onClick={() => changeListStyle('upper-roman')}>I.</button>
                                    <button className="btn btn-xs custom-button" onClick={() => changeListStyle('lower-roman')}>i.</button>
                                    <button className="btn btn-xs custom-button" onClick={() => changeListStyle('upper-alpha')}>A.</button>
                                    <button className="btn btn-xs custom-button" onClick={() => changeListStyle('lower-alpha')}>a.</button>
                                </div>
                            </h5>
                    ...
                    <div contentEditable="true" className="col-sm-9 text-center" id="right">
                        ...
                        <div id="page" className="droid">
                            ...
                            <div className="section" id="sectionSkills">
                                ...
                                <ul>
                                    <li>
                                        <strong><span className="skillCategory">Programming languages</span> :</strong> C++, Python, Java *
                                    </li>
                                    <li>
                                        <strong><span className="skillCategory">Web technologies</span> :</strong> HTML, CSS, Javascript
                                    </li>
                                    <li>
                                        <strong><span className="skillCategory">Database management</span> :</strong> mySQL
                                    </li>
                                    <li>
                                        <strong><span className="skillCategory">Miscellaneous</span> :</strong> Android programming *
                                    </li>
                                    <li>
                                        <strong><span className="skillCategory">Operating system</span> :</strong> Windows, Linux
                                    </li>
